...
`setLines(linesArr)`: linesArr is an array with the following form:
   ...
   If you have 3 explainer values and would like to add footnote for each of them, please give an array with 3 array of strings inside. i.e., `[["lineA1", "lineA2", "lineA3"], ["lineB1", "lineB2"], ["lineC1", "lineC2"]]`. If you only want to add footnote for the first and the third figure, please still provide an empty array for the second figure. i.e., `[["lineA1", "lineA2", "lineA3"], [], ["lineC1", "lineC2"]]`
